 ...
 * Origin: https://svn.apache.org/viewvc/pdfbox/branches/1.8/pdfbox/src/main/java/org/apache/pdfbox/util/TIFFUtil.java?revision=1802511&view=co
 */
...
class TIFFUtil {
    ...
    public static void updateMetadata(IIOMetadata metadata, BufferedImage image, int dpi)
    {
        ...
        {
            System.err.println("TIFF image writer doesn't support any data format");
            return;
        }
        ...
        // TODO Let the user configure this property.
        ifd.appendChild(createAsciiField(305, "Software", "nifi-pdf2tiff"));
